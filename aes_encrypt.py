...
def inv_mix_columns(state):
    ...
    temp[0] = g_mul2[stateInt[0]] ^ g_mul3[stateInt[1]] ^ stateInt[2] ^ stateInt[3]
    temp[1] = stateInt[0] ^ g_mul2[stateInt[1]] ^ g_mul3[stateInt[2]] ^ stateInt[3]
    temp[2] = stateInt[0] ^ stateInt[1] ^ g_mul2[stateInt[2]] ^ g_mul3[stateInt[3]]
    temp[3] = g_mul3[stateInt[0]] ^ stateInt[1] ^ stateInt[2] ^ g_mul2[stateInt[3]]

    temp[4] = g_mul2[stateInt[4]] ^ g_mul3[stateInt[5]] ^ stateInt[6] ^ stateInt[7]
    temp[5] = stateInt[4] ^ g_mul2[stateInt[5]] ^ g_mul3[stateInt[6]] ^ stateInt[7]
    temp[6] = stateInt[4] ^ stateInt[5] ^ g_mul2[stateInt[6]] ^ g_mul3[stateInt[7]]
    temp[7] = g_mul3[stateInt[4]] ^ stateInt[5] ^ stateInt[6] ^ g_mul2[stateInt[7]]

    temp[8] = g_mul2[stateInt[8]] ^ g_mul3[stateInt[9]] ^ stateInt[10] ^ stateInt[11]
    temp[9] = stateInt[8] ^ g_mul2[stateInt[9]] ^ g_mul3[stateInt[10]] ^ stateInt[11]
    temp[10] = stateInt[8] ^ stateInt[9] ^ g_mul2[stateInt[10]] ^ g_mul3[stateInt[11]]
    temp[11] = g_mul3[stateInt[8]] ^ stateInt[9] ^ stateInt[10] ^ g_mul2[stateInt[11]]

    temp[12] = g_mul2[stateInt[12]] ^ g_mul3[stateInt[13]] ^ stateInt[14] ^ stateInt[15]
    temp[13] = stateInt[12] ^ g_mul2[stateInt[13]] ^ g_mul3[stateInt[14]] ^ stateInt[15]
    temp[14] = stateInt[12] ^ stateInt[13] ^ g_mul2[stateInt[14]] ^ g_mul3[stateInt[15]]
    temp[15] = g_mul3[stateInt[12]] ^ stateInt[13] ^ stateInt[14] ^ g_mul2[stateInt[15]]
...
def aes_decrypt(ciphertext):
    ...
    for i in range(0, num_rounds*4, 4):
        # stateInt = get_stateInt(state)
        # print("stateInt in d: ", stateInt)
        # print("state in d: ", state)
        inv_shift_rows(state)
        print()
        print("shiftrow_decrypt", state)
        inv_sub_bytes(state)
        print("sub_bytes_decrypt", state)
        print()
    ...
    # inv_shift_rows()
    # inv_sub_bytes()
    # finalOuput = add_round_key()
    # print("finalOutput of Decryption: ", finalOutput)
    print()
